...
HD_PWD='/home/tianzhao/quartus_16_fringe_ref/spatial-lang-arria10/gen/DRAMWriteTest/verilog-zynq/project_1/project_1.runs/design_1_axi_register_slice_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_register_slice_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_register_slice_3_0.tcl
