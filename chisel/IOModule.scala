...
trait IOModule extends Module {
  ...
  // Complete config:  --SpatialConf$module=null --PlasticineConf$module=null --useBasicBlocks=false --targetName=null --target=spatial.targets.DefaultTarget$@7bd6eb1a --enableDSE=false --heuristicDSE=true --bruteForceDSE=false --experimentDSE=false --enableDot=false --inputs=[Ljava.lang.String;@da77019 --enableInterpret=false --enableSim=false --enableSynth=true --enablePIR=false --enablePIRSim=false --pirsrc=None --enableRetiming=false --enableSplitting=false --enableArchDSE=false --enableSyncMem=false --enableInstrumentation=false --useCheapFifos=false --enableTree=true --plasticineSpec=PlasticineConf(10,2,5,16,4,2,6,2,7,16,4,1,4,1,0,16,16,32) --threads=8
